...
# 프로그램이 구한 파동함수, 빨간색 점
axis00.plot(x, sess.run(psi), color='r', lw=0.5, label='The wave function found by the program')
axis00.scatter(x, sess.run(psi), color='r', s=1)
...
axis01.annotate(f'{energys[-1]}', xytext = (steps, energys[-1]+(energys[0]-energys[-1])/10),
